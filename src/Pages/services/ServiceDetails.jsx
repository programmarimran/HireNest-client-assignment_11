...
const ServiceDetails = () => {
  ...
  return (
    <div className=" py-24">
<div className={`max-w-5xl mx-auto border rounded-2xl py-4 px-4 ${darkIstrue ? "text-white border-gray-600 shadow-md" : "text-gray-800 border-gray-200 shadow-md"}`}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400 mb-1">Location: {service.serviceArea}</p>
          ...
          <div className="flex items-center gap-3 my-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">{service.provider.email}</p>
            </div>
          </div>
